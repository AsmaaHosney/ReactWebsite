...
export default function Stars2( ) {
  return (
    ...
    <div>
       <div className="mx-auto mt-3 flex items-center justify-center space-x-10 mb-3">
        <div className="bg-mainColor w-24 rounded-xl h-2">  </div>
        <div className="w-8 fill-mainColor">
